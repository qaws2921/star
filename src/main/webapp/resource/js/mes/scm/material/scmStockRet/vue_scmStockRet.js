...
window.onload = function () {
    new Vue({
        ...
        mounted: function(){
            ...
            jquery_scmStockRet(_this); // vue 에서 실행 못하는 jquery
            _this.selectBox();
        ...
        methods:{
            main_gat_btn:function (page) { // 조회 버튼
                ...
                $('#jqGrid').setGridParam({ url: 'scmStockRet/sp_scm_stock_rev_get',postData: _this.keyword_post ,datatype: "json", page: page}).trigger("reloadGrid");
            },
