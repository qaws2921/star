...
<script src="resource/js/mes/scm/material/scmStockRev//vue_scmStockRev.js"></script>
<script src="resource/js/mes/scm/material/scmStockRev/jquery_scmStockRev.js"></script>
<script>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <div v-cloak id="app">
        <table class="menu-class">
            <tbody>
            <tr>
                <td class="left-header">재고조정</td>
                <td class="right-header"><i class="fas fa-home"></i> > SCM > 자재 > 재고조정</td>
            </tr>
            </tbody>
        </table>
