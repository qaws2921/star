...
<script src="resource/js/mes/scm/material/scmOutOrder//vue_scmOutOrder.js"></script>
<script src="resource/js/mes/scm/material/scmOutOrder/jquery_scmOutOrder.js"></script>
<script>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <div v-cloak id="app">
        <table class="menu-class">
            <tbody>
            <tr>
                <td class="left-header">출고요청</td>
                <td class="right-header"><i class="fas fa-home"></i> > SCM > 자재 > 출고요청</td>
            </tr>
            </tbody>
        </table>
            ...
            <div class="public-mg">
                <table class="table table-border-bl" >
                    <tr>
                        ...
                        <td class="w-150px">
                            <select id="cargo_group_select"  v-model="keyword_modal.keyword2">
                                ...
                                <div class="public-mg">
                                    <table>
                                            ...
                                            <td>
                                                <table class="table table-border-bl" style="margin-bottom: 5px;" >
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input id="date_input3" class="input-modal" v-model="out_order.work_date">
                                                        </td>
                                                        <td class="top-td-la" style="padding-top: 10px;">
                                                            받을창고
                                                        </td>
                                                        <td>
                                                            <select id="cargo_group_modal_select">
                                                                <option value="">선택안함</option>
                                                                <option v-for="(cg,index) in cargo_group" :key="index" :value="cg.cargo_code">{{ cg.cargo_name}}</option>
                                                            </select>
                                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="text-align: center; margin:auto; width: 35px">
