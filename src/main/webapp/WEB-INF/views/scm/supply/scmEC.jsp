...
<script src="resource/js/mes/scm/supply/scmEC//vue_scmEC.js"></script>
<script src="resource/js/mes/scm/supply/scmEC/jquery_scmEC.js"></script>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <div v-cloak id="app">
        <table class="menu-class">
            <tbody>
            <tr>
                <td class="left-header">출고증 관리</td>
                <td class="right-header"><i class="fas fa-home"></i> > SCM > 사급품 > 출고증 관리</td>
            </tr>
            </tbody>
        </table>
