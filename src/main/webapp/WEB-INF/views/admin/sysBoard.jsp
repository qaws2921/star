...
<script src="resource/js/mes/admin/sysBoard/vue_sysBoard.js"></script>
<script src="resource/js/mes/admin/sysBoard/jquery_sysBoard.js"></script>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body form-inline">
                                    ...
                                    <div class="mg-5 mg-auto form-group">
                                        ...
                                        <input v-model="sys_board_cd.files" id="test5" class="form-control in-s-50">
                                    </div>
                                    <div class="mg-5 mg-auto form-group">
                                        <label for="test2" class="label-ba">최대파일크기(MB)</label>
                                        <input v-model="sys_board_cd.file_size" id="test5" class="form-control in-s-50">
                                    </div>
                                    <div class="mg-5 mg-auto form-group">
