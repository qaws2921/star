...
public class SP_SCM_IN_READY_GET {
    ...
    public void setPart_grp_code(String part_grp_code) {
        this.part_grp_code = part_grp_code;
    }
    ...
    public void setPack_qty(int pack_qty) {
    ...
    public String getOrder_qty_s() {
        return order_qty_s;
    }

    public void setOrder_qty_s(String order_qty_s) {
        this.order_qty_s = order_qty_s;
    }

    public String getBad_qty_s() {
        return bad_qty_s;
    }

    public void setBad_qty_s(String bad_qty_s) {
        this.bad_qty_s = bad_qty_s;
    }

    public String getIn_qty_s() {
        return in_qty_s;
    }
