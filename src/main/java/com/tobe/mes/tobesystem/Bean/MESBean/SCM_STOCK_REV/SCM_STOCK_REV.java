...
public class SCM_STOCK_REV {
    ...
    public String getStock_qty_prev() {
        return stock_qty_prev;
    }

    public void setStock_qty_prev(String stock_qty_prev) {
        this.stock_qty_prev = stock_qty_prev;
    }
